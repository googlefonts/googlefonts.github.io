...
- no all caps
- only basic ASCII glyphs (A-Z, a-z, 0-9), i.e., no hyphens, underscores, or accented letters.
...
The vertical metrics should be the same in each sibling family, and the "Use Typo Metrics" flag should be set.
